...
final class ToastView: UIView {
    ...
    init(parameters: Parameters, frame: CGRect) {
        ...
        if parameters.message != nil {
            titleHeight = (frame.height * 0.5) - 5
        } else {
        ...
        if let message = parameters.message {
            ...
            messageLabel.frame = CGRect(x: titleLabel.frame.origin.x, y: titleLabel.frame.height + 5, width: titleLabel.frame.width, height: titleLabel.frame.height)
